...
public class InicioSesionController implements Initializable {
    ...
    private void abrirDashboard(Usuario usuario) {
        ...
        switch (rol) {
            case "admin":
                rutaDashboard = "/org/ae/view/fxml/AdminDashboradView.fxml";
                break;
            case "cajero":
                rutaDashboard = "/org/ae/view/fxml/AdminDashboradView.fxml";
                break;
        ...
        if (rutaDashboard.equals("/org/ae/view/fxml/InicioSesionView.fxml")) {
